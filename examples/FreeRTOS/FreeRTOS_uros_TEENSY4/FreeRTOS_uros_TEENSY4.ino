...
void setup() {
  ...
  portBASE_TYPE rostask;
  // initialize semaphore
  sem = xSemaphoreCreateCounting(1, 0);
  rostask = xTaskCreate(ros_spin_task, "ros_task", configMINIMAL_STACK_SIZE + 1000, NULL, tskIDLE_PRIORITY+1, NULL);

  // check for creation errors
  if (sem== NULL || rostask != pdPASS) {
    debug_blink(100, 20);   // pass
  }
